...
public class ListerActivitesContoller extends HttpServlet{
	@Inject private ActiviteService activiteService;
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		List<CollabEvt> listeActivites=activiteService.listerActivitesCollab();
		
		req.setAttribute("listeActivites", listeActivites);
